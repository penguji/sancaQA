...
def verify_service_not_available():
    ...
    assert (
        ...
        == "Sebagai antisipasi penyebaran COVID-19, kami menghentikan layanan GoMassage untuk sementara di semua wilayah. Keamanan & keselamatan semua pihak merupakan prioritas utama kami."
    )
